function []= IntrinsicsMastCam(A_ML,H_ML,V_ML,A_MR,H_MR,V_MR,C_ML,C_MR,R_ML,R_MR)
...
CameraParamsLM= cameraParameters('IntrinsicMatrix',IntrinsicMatrixLeft,'ImageSize',img_size,'RadialDistortion',radialDistortionL); 
...
CameraParamsRM= cameraParameters('IntrinsicMatrix',IntrinsicMatrixRight,'ImageSize',img_size,'RadialDistortion',radialDistortionR); 
%% SAVING Parameters
