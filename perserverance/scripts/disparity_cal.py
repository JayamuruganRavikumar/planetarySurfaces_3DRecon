...
def update(value = 0):
    stereo.setBlockSize(cv2.getTrackbarPos('window_size',
    'disparity'))
    ...
    stereo.setSpeckleRange(cv2.getTrackbarPos('speckleRange',
    'disparity'))
...
if __name__ == "__main__":
    ...
    P1 = 600
    P2 = 2400
    imgL = cv2.imread('rectified_1.png')
    imgR = cv2.imread('rectified_2.png')
